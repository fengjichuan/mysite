			...
			for (var i = inst.snapElements.length - 1; i >= 0; i--) {
				...
				if (!((l - d < x1 && x1 < r + d && t - d < y1 && y1 < b + d) || (l - d < x1 && x1 < r + d && t - d < y2 && y2 < b + d) || (l - d < x2 && x2 < r + d && t - d < y1 && y1 < b + d) || (l - d < x2 && x2 < r + d && t - d < y2 && y2 < b + d))) {
					if (inst.snapElements[i].snapping)
						(inst.options.snap.release && inst.options.snap.release.call(inst.element, null, $.extend(inst.uiHash(), {
		...
		_mouseStop : function(e, noPropagation) {
			...
			if (this.options.revert) {
				...
				$(this.helper).animate({
					...
					self._clear(e);
					self.options.stop(e, self.options);
				});
			} else {
				this._clear(e, noPropagation);
				this.options.stop(e, this.options);
			}
			return false;
		},
